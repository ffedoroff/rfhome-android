 ...
 */
public class RFHomeGridPagerAdapter extends FragmentGridPagerAdapter {
    ...
    public RFHomeGridPagerAdapter(Context ctx, FragmentManager fm) {
        super(fm);
        mContext = ctx;
...
//                cardFragment(R.string.columns_title, R.string.columns_text)));
        mRows.add(new Row(new Fragment4(), new CustomFragment()));
        mRows.add(new Row(cardFragment(R.string.dismiss_title, R.string.dismiss_text)));
        mDefaultBg = new ColorDrawable(android.R.color.darker_gray);
...
//                int resid = R.drawable.card_background;
//                new DrawableLoadingTask(mContext) {
//                    @Override
//                    protected void onPostExecute(Drawable result) {
//                        TransitionDrawable background = new TransitionDrawable(new Drawable[] {
